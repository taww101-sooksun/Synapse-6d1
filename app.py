...
# =========================================================
# [ ระบบเชื่อมต่อฐานข้อมูล SOOKSUN-101 ป้องกันคีย์พัง ]
# =========================================================

# ล้างแอปเก่าที่ค้างอยู่ในหน่วยความจำป้องกันการแย่งสิทธิ์
...
try:
    # 1. ดึงข้อมูล Dictionary จากกล่อง Secrets แฟ้ม [firebase]
    firebase_cfg = {
