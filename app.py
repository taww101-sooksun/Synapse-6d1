...
st.success("📢 ฝากบอกทุกท่านด้วยนะคนับ  กรุณาแจ้งพื่นที่ตามตรงด้วยนะครับ เพือความซื่อตรงและความถูกต้องผมเลยทำเตรื่องมือวัดจำนวการไถนาอันนี้ขึ้นมา สะโลแกน อยู่นิ้งๆไม่เจ็บตัว เด้อครับพี่น้อง!🚜") 
